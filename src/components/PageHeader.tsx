    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          {rightLink && (
            <Link to={rightLink.to} className="hidden h-11 items-center rounded border border-slate-300 px-4 text-sm font-black text-slate-600 hover:bg-slate-50 sm:inline-flex">
              {rightLink.label}
            </Link>
          )}
