...
const TripSummary = () => (
  <aside className="h-fit rounded border border-slate-300 bg-white shadow-sm">
    ...
    <div className="space-y-6 p-6">
      {[
        ['Outbound Flight', 'AOR to KUL', 'Thu, 28 May 2026'],
        ['Return Flight', 'KUL to AOR', 'Wed, 10 Jun 2026'],
      ].map(([title, route, date]) => (
        <div key={title} className="border-b border-dashed border-slate-300 pb-5">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="rounded bg-slate-200 px-2 py-1 text-[10px] font-black uppercase text-[#073b70]">Economy</span>
          </div>
          <p className="text-base font-black text-[#073b70]">{route}</p>
      ...
      <div className="space-y-3 bg-slate-100 p-4 text-sm font-bold text-slate-600">
        <div className="flex justify-between"><span>Base Fare</span><span>THB 450.00</span></div>
        <div className="flex justify-between"><span>Taxes & Fees</span><span>THB 100.00</span></div>
        <div className="flex justify-between border-t border-slate-300 pt-3 font-black text-[#073b70]"><span>Total</span><span>THB 550.00</span></div>
      </div>

      <Link to="/add-ons" className="flex h-14 items-center justify-center rounded bg-[#073b70] text-sm font-black text-white shadow-md shadow-blue-950/15">
        Continue to Add-ons
      </Link>
        ...
        <section>
          <div className="mb-7">
            ...
            <p className="mt-2 text-sm font-semibold text-slate-500">
              Please enter passenger details exactly as shown on passport or official documents.
            </p>
          </div>
          ...
          <div className="mt-16 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link to="/add-ons" className="flex h-12 w-60 items-center justify-center rounded bg-[#073b70] text-sm font-black text-white shadow-md shadow-blue-950/20">
              Save & Continue →
            </Link>
          </div>
        </section>
